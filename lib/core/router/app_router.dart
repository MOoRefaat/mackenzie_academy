...
import 'package:mackenzie_academy/features/add_users_by_admin/presentation/register/screens/adding_users_screen.dart';
import 'package:mackenzie_academy/features/app_settings/presentation/screens/app_settings_screen.dart';
...
class AppRouter {
  static Route<dynamic>? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutesName.appSettingsRoute:
        return MaterialPageRoute(
