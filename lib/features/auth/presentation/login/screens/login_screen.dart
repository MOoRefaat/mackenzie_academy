...
class LoginScreen extends StatelessWidget {
        ...
        child: BlocConsumer<LoginBloc, LoginState>(
          listener: (context, state) {
            if (state is LoginInitial) {
              ...
              // _checkEmailAndPasswordStatePasswordState(context);
            } else if (state is ValidateStoredDataState) {
              ...
              _callFirebaseLogin(
                  state.email, state.password, state.isRememberMe, context);
  ...
  Widget _buildEmailTextField() {
    return CustomTextField(
      ...
      hintText: '${S.current.label_email}',
  ...
  Widget _buildPasswordTextField() {
    return CustomTextField(
      ...
      hintText: '${S.current.label_password}',
  ...
  Widget _buildLoginButton(BuildContext context) {
    return CustomButton(
      buttonLabelText: S.current.title_login,
  ...
  void _callFirebaseLogin(
      String email, String password, bool isRememberMe, BuildContext context) {
    BlocProvider.of<LoginBloc>(context).add(CallFirebaseLoginEvent(
